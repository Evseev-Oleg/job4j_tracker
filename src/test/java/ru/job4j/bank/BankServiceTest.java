...
public class BankServiceTest {
    ...
    public void whenEnterInvalidPassport() {
        ...
        Optional<Account> excepted = bank.findByRequisite("34", "5546");
        assertNull(excepted.isPresent() ? excepted : null);
    }
    ...
    @Test
    public void transferMoneyNotAccount() {
        User user = new User("3434", "Petr Arsentev");
        BankService bank = new BankService();
        bank.addUser(user);
        bank.addAccount(user.getPassport(), new Account("554", 150D));
        bank.addAccount(user.getPassport(), new Account("113", 50D));
        bank.transferMoney(user.getPassport(), "5546", user.getPassport(), "113", 150D);
    ...
    @Test
    public void transferMoneyNotBalance() {
        User user = new User("3434", "Petr Arsentev");
        BankService bank = new BankService();
        bank.addUser(user);
